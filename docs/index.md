...
<section class="info-box">
  <ul>
    ...
    <li>Dokumentace pro snadné používání a sdílení</li>
    <li>Kód připravený pro další rozvoj</li>
  </ul>
</section>
...
<section class="info-box">
  <ol>
    <li>Forkněte repo</li>
    <li>Vytvořte nový branch pro změny</li>
    <li>Odešlete Pull Request s popisem změn</li>
  </ol>
</section>